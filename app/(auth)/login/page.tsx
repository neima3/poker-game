  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader className="text-center">
        ...
        <CardDescription>Sign in to your PokerApp account</CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <form action={login} className="space-y-3">
          ...
          />
          <SubmitButton pendingText="Signing in…" className="w-full bg-felt text-white hover:bg-felt-dark">
            Sign In
          </SubmitButton>
        </form>
